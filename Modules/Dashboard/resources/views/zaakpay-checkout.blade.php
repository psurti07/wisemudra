<form action="{{ $curlurl }}" name="frm1" method="post">
    ...
    <input type="hidden" name="buyerLastName" value='{{ $zaakpayPostData ['buyerLastName'] }}'/>
    ...
    <input type="hidden" name="product1Description" value='{{ $zaakpayPostData ['product1Description'] ?? '' }}'/>
