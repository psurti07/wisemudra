...
@endpush
@section('content')
<section id="hero-201" class="bg--white-100 bg--fixed hero-section bg--blue-500 feature-main-wrap">
    <div class="container">
        <div class="row d-flex align-items-center">
            <div class="col-md-6 col-lg-6 order-lg-1 order-2 mb-md-0 mb-3">
                <div class="mt-30 mb-20">
                    <h2 class="s-50 mb-5 color--white">Get Instant <span class="color--green-500">Cash</span></h2>
                    <h3 class="s-24 mb-20 color--white">Up to <span class="color--green-500">₹10 Lakhs</span> in 24
                        Hours</h3>
                    ...
                    <div class="row gx-2 gy-2 row-cols-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-3 mb-10 mt-4">
                        ...
                        <div class="col">
                            <div class="fbox-7 fbox--hover bg--white-100 fb-1 r-12 p-3 bg--blue-400">
                                <div class="fbox-ico mb-2">
                                    <div class="fbox-image  ico-20">
                                        <span class="flaticon-coin text-white lh-1"></span>
                                    </div>
                                </div>
                                <div class="fbox-txt">
                        ...
                        <div class="col">
                            <div class="fbox-7 fbox--hover bg--white-100 fb-1 r-12 p-3 bg--blue-400">
                                <div class="fbox-ico mb-2">
                                    <div class="fbox-image  ico-20">
                                        <span class="flaticon-bar-chart text-white lh-1"></span>
                                    </div>
                                </div>
                                <div class="fbox-txt">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-12">
                        <p class="btn-txt mb-3 ico-15 color--white"><span class="flaticon-check color--theme"></span> No
                            Collateral Required</p>
                        <p class="btn-txt mb-3 ico-15 color--white"><span class="flaticon-check color--theme"></span>
                            Flexible
                            Repayment Options</p>
                    </div>
            ...
            <div class="col-md-6 col-lg-6 self-apply-form order-lg-2 order-1">
                <div id="hero-8-form" class="r-24 bg--blue-400">
                    <div class=" d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="s-22 w-700 mb-1 color--white">Apply in just <span class="color--green-500">5
                                    Minutes</span> </h4>
                            <p class="s-16">Get instant pre-approved offers.</p>
                        </div>
                        <div>
                            <img class="light-theme-img" src="{{ asset('front/images/self-apply-img.png') }}"
                                alt="feature-image">
                        </div>
                    </div>
                    <form method="post" action="{{ route('self.apply.send.otp') }}"
                        class="request-form request-form-01 save-form-1 needs-validation" novalidate>
                        <div class="row g-2">
                            <div class="col-md-12">
                                    ...
                                    <div class="row gx-2">
                                        <div class="col-md-6 col-lg-6 col-sm-6 mb-2">
                                            <fieldset class="picker1">
                                                <label class="card bg-transparent" for="personalloan">
                                                    <input type="radio" name="loan_type" id="personalloan" value="1"
                                                        class="radio" checked>
                                                    <span class="plan-details border border-secondary">
                                                        <span class="plan-type color--white">Personal Loan</span>
                                                    </span>
                                                </label>
                                            </fieldset>
                                        </div>
                                        <div class="col-md-6 col-lg-6 col-sm-6 mb-2">
                                            <fieldset class="picker1">
                                                <label class="card bg-transparent" for="businessloan">
                                                    <input type="radio" name="loan_type" id="businessloan" value="2"
                                                        class="radio">
                                                    <span class="plan-details border border-secondary">
                                                        <span class="plan-type color--white">Business Loan</span>
                                                    </span>
                                                </label>
                                            </fieldset>
                                        </div>
                                ...
                                <div class="form-group form-floating">
                                    ...
                                    <div class="mb-2">
                                        <select name="user_type" id="user_type"
                                            class="form-control form-select bg--blue-400 border border-secondary text-white r-12">
                                            <!-- Personal Options -->
                            ...
                            <div class="col-md-12">
                                <label for="form_mobile"
                                    class="position-static p-0 text-uppercase s-14 mb-2 fw-normal color--grey d-block text-start">Mobile
                                    Number</label>
                                <div class="input-group">
                                    <div class="input-group-prepend  bg--blue-400 border-secondary border text-white">
                                        <span class="input-group-text" id="basic-addon1">+91</span>
                                    </div>
                                    <input type="text" name="mobile" id="mobile"
                                        class="numeric-input form-control name bg--blue-400 border border-secondary"
                            ...
                            <div class="col-md-12 form-btn">
                                <button type="submit" id="checkmodal"
                                    class="btn btn--theme hover--theme submit rounded-pill">Apply
                                    Now <span class="fbox-ico ico-10"> <span class="flaticon-right-arrow  ico-20 ms-1"></span></span></button>
                            </div>
                            <div class="col-md-12"><span class="text-danger" id="usererrormsg"></span></div>
                        </div>

                        <p class="mb-0 s-14 text-start">By submitting, you agree to Wisemudra's <a
                                href="{{ route('front.terms.conditions') }}" target="_blank"
                                class="text-decoration-none">Terms of Use</a> and <a
                                href="{{ route('front.privacy.policy') }}" class="text-decoration-none"
                                target="_blank">Privacy Policy</a>, and consent to receive promotional and
                            informational
                            messages via email, call, or SMS.</p>
                    </form>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-12 col-lg-12">
                    <div class="section-title mb-50">
                        ...
                        <p class="color--grey mt-0">Partnering with the best NBFCs to provide the best for our
                            customers.</p>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10 col-lg-9">
                <div class="section-title mb-50">
                    <h2 class="s-28 mb-2 text-white">Why <span class="color--green-500">Wisemudra</span></h2>
                    <p class="color--grey mt-0">Here's what sets us apart.</p>
                </div>
            </div>
        </div>
            ...
            <div class="row gx-3 gy-4 row-cols-1 row-cols-md-2 row-cols-lg-4">
                <div class="col">
                    <div class="fbox-8 fbox--hover fb-1 text-start bg--blue-400 h-100">
                        <div class="fbox-ico">
                            ...
                            <div class="fbox-image  ico-20">
                                <span class="flaticon-layers-1 text-white lh-1"></span>
                            </div>
                        </div>
                        <div class="fbox-txt">
                            <h4 class="s-18 w-700 color--white">Enriching Collaboration</h4>
                            <p class="color--grey">Access a wide range of financial services empowered by our
                                industry-leading NBFC
                                partners.</p>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="fbox-8 fbox--hover fb-1 text-start bg--blue-400 h-100">
                        <div class="fbox-ico">
                            <div class="fbox-image  ico-20">
                                <span class="flaticon-computer-1 text-white lh-1"></span>
                            </div>
                        </div>
                        <div class="fbox-txt">
                            <h4 class="s-18 w-700 color--white">100% Online Process</h4>
                            <p class="color--grey">Experience the convenience and power of digital provisions from the
                                comfort of your own
                                home.</p>
                        </div>
                    </div>
                ...
                <div class="col">
                    <div class="fbox-8 fbox--hover fb-1 text-start bg--blue-400 h-100">
                        <div class="fbox-ico">
                            <div class="fbox-image  ico-20">
                                <span class="flaticon-click-1 text-white lh-1"></span>
                            </div>
                        </div>
                        <div class="fbox-txt">
                            <h4 class="s-18 w-700 color--white">Self-Apply Feature</h4>
                            <p class="color--grey">Take charge of your own finances while reaping the benefits of
                ...
                <div class="col">
                    <div class="fbox-8 fbox--hover fb-1 text-start bg--blue-400 h-100">
                        <div class="fbox-ico">
                            <div class="fbox-image  ico-20">
                                <span class="flaticon-tech-support  text-white lh-1"></span>
                            </div>
                        </div>
                        <div class="fbox-txt">
                            <h4 class="s-18 w-700 color--white">Hire Loan Agent</h4>
                            <p class="color--grey">Benefit from our experts' insights and strategies to increase your
                                chances of loan
                                approval.</p>
                        </div>
                    </div>
...
<section id="reviews-1" class="py-80 shape--06 reviews-section bg--blue-100">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12 col-lg-12">
                <div class="section-title mb-50">
                    <h2 class="s-28 mb-2">What Our <span class="color--green-500">Customer Says</span></h2>
                    <p class="color--grey">Hear directly from our customers about their experiences with us.</p>
                </div>
            </div>
        </div>
        <div class="row">
...
<section class="py-20 shape--06 bg--blue-100 border-top">
    <div class="container">
        <div class="row justify-content-center">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content p-30 border-radius-10">
            <form action="{{ route('self.apply.verify.otp') }}" method="post"
                ...
                <button type="submit" id="otpBtn" class="btn btn--theme hover--theme submit mt-3 w-100 rounded-pill">Verify OTP <span class="fbox-ico ico-10"> <span class="flaticon-right-arrow  ico-20 ms-1"></span></span></button>
            </form>
        </div>
    </div>
</div>
