...
<section id="contacts" class="gr--perl pt-140 contacts-section workshop-section division">
    <div class="container">
                        ...
                        <div class="col-lg-9">
                            <div class="row">
                                <div class="col-md-4 col-lg-6 col-12 mb-lg-0 mb-3">
                                    <div class="card">
                                        <div class="sub-blog-card bg-white mb-20" style="box-shadow: none;">
                                            <div class="img img-cover">
                                                ...
                                                <div class="article-thumb image-wrap">
                                                    <img class="web-image w-100" src="{{ env('PATH_ADMIN_PANEL_IMAGE') . $displayWebinar->event_image }}" alt="images">
                                                </div>
                                                @else
                                                <img src="{{ asset('upload/webinar/1750402770.jpg') }}" alt="{{ $isDefault ? 'Upcoming Webinar' : ($displayWebinar->name ?? 'Webinar') }}">
                                                @endif
                                            </div>
                                        ...
                                        <div class="row pt-4 px-3">
                                            <label class="">
                                                ...
                                                <div class="plan-details">
                                                    ...
                                                    @php
                                                    // Price selection
                                                    $price = ($displayWebinar->event_offer_price > 0) ? $displayWebinar->event_offer_price : ($displayWebinar->event_main_price ?? 299);
