...
<section id="contacts" class="bg--green-100 personal-details-form pb-100 inner-page-hero contacts-section division">
    <div class="container">
                                ...
                                <form action="{{ route('webinar.personal.details-submit') }}" id="personalDetailForm" class="contact-form signup-form" novalidate="novalidate" method="post" accept-charset="utf-8">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-10 col-md-10 col-12">
                                                <div class="form-group mb-3">
                                                    <small class="d-block text-start color-000 mb-0 fsz-14">Current Occupation <span
                                                            class="text-danger">*</span></small>
                                                    <input type="text" name="occupation" class="form-control mb-0 fsz-14 radius-2"
                                                        placeholder="Ex.Engineer">
                                                    @component('components.ajax-error', ['field' => 'occupation'])
                                                    @endcomponent
                                                </div>
                                            </div>
                                            <div class="col-lg-10 col-md-10 col-12">
                                                <div class="form-group mb-3">
                                                    <small class="d-block text-start color-000 mb-0 fsz-14">Earning Goal <span
                                                            class="text-danger">*</span></small>
                                                    <input type="text" name="earning_goal" class="form-control mb-0 fsz-14 radius-2"
                                                        placeholder="5,00,000">
                                                    @component('components.ajax-error', ['field' => 'earning_goal'])
                                                    @endcomponent
                                                </div>
                                            </div>
                                            <div class="col-lg-10 col-md-10 col-12">
