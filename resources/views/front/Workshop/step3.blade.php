                ...
                <div class="col-lg-8 col-md-10 col-sm-12 offset-md-1">
                    <div class="row">
                        ...
                        <div class="col-md-8 col-lg-8 col-12">
                            <div class="card">
                                <form action="{{ route('workshop.personal.details-submit') }}" id="personalDetailForm" class="contact-form signup-form" novalidate="novalidate" method="post" accept-charset="utf-8">
                                    <div class="card-body">
