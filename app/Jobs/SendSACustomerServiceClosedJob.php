...
class SendSACustomerServiceClosedJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        try {
            ...
            $data1 = array(
				...
				'crontype' => 'Self Apply Customer Service Closed',
            ...
            Log::error("Failed to send SA Customer Service Closed to {$this->user->mobile}: " . $e->getMessage());
