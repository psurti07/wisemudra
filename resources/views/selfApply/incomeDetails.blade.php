...
@section('content')
<!-- main section starts -->
<section id="hero-201" class="bg--blue-400 bg--fixed hero-section">
    <div class="container">
        <div class="row d-flex align-items-center justify-content-center m-auto">
            <div class="col-md-8 col-lg-6 self-apply-form m-auto">
                <div id="hero-8-form" class="r-24 bg--blue-500">
                    ...
                    <form method="post" action="{{ route('self.apply.loan.details.store') }}"
                        class="request-form request-form-01 save-form-3 needs-validation" novalidate>
                        <div class="row">
                            ...
                            <div class="col-md-12 mt-4 mb-2">
                                <label for="form_mobile"
                                        class="position-static p-0 text-uppercase s-14 mb-2 color--grey text-start d-block">enter monthly income</label>
                                <div class="input-group">
                                    <div class="input-group-prepend border-secondary border color--green-500 bg--blue-400">
                                        <span class="input-group-text px-4 bg--blue-400" id="basic-addon1">&#8377;</span>
                                    </div>
                                    <input type="text" name="monthly_income" id="monthly_income"
                                        class="numeric-input form-control mb-0 bg--blue-400 border border-secondary"
                            ...
                            <div class="col-md-12 mb-2">
                                              <label for="form_mobile"
                                        class="position-static p-0 text-uppercase s-14 mb-2 color--grey text-start d-block">enter current emi (if any)</label>
                                <div class="input-group">
                                    <div class="input-group-prepend border-secondary border color--green-500 bg--blue-400">
                                        <span class="input-group-text px-4 bg--blue-400" id="basic-addon1">&#8377;</span>
                                    </div>
                            ...
                            <div class="col-md-12 form-btn mt-3">
                                <button type="submit" class="btn btn--theme hover--theme submit processNowBtn w-100 rounded-pill"
                                    id="processNowBtn"
