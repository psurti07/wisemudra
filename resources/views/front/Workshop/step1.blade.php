...
<section id="" class="py-120 bg--fixed gr--perl hero-section">
    <div class="container">
        <div class="row d-flex align-items-center">
            ...
            <div class="col-md-5 col-lg-5 self-apply-form">
                <div id="hero-8-form" class="r-06">
                    ...
                    <form method="post" action="{{ route('workshop.storeStep1') }}" class="request-form signup-form needs-validation " novalidate>
                        <div class="row g-2">
                            <div class="col-md-12">
...
<section class="bg--03 mt-50 py-50 ct-03 content-section division">
    <div class="container">
        <div class="row d-flex align-items-center">
            ...
            <div class="col-md-2 col-lg-2">
                <div class="d-flex align-item-center text-center justify-content-center">
                    <a href="{{ route('workshop.step1') }}" class="btn r-04 btn--theme hover--tra-white last-link">Let's Start</a>
                </div>
            </div>
        </div>
    </div>
